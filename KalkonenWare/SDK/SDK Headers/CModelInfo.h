...
struct ColorMeshInfo_t
{
	...
	// (in which case it uses a sub-range defined by m_nVertOffset and m_nNuClientVarserts)
	void* m_pMesh;
	void* m_pPooledVBAllocator;
	int m_nVertOffsetInBytes;
	int m_nNuClientVarserts;
};
...
public:
	...
	virtual int NuClientVarsertexShaderConstants() const = 0;
...
public:
	...
	virtual void LoadKeyValuesFroClientVarsMTFile( KeyValues& values, const char* name, bool somebool ) const = 0;
